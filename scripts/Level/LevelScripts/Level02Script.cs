...
public class Level02Script : LevelScript {
	...
	{
		if (PlayerManager.main.playerData.WordStorage.ContainsFoundWord(thisPhrase)) {
	...
	void HandleOnInteractiveDialogOpened (object sender, System.EventArgs e)
	{
		...
		if (!PlayerManager.main.playerData.WordStorage.ContainsFoundWord(thisPhrase)) {
			...
			TutorialCanvas.main.ClearLines ();
            TutorialCanvas.main.CreateWorldLine(PlayerManager.main.PlayerGameObject.transform, overhearTarget);
		}
	}
