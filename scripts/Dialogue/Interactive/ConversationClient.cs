...
public class ConversationClient : MonoBehaviour {
	...
	void Start () {
		...
		PlayerManager.main.OnLevelChanged += HandleOnStateChanged;
	...
	{
		PlayerManager.main.playerData.FriendData.SetFriendState (clientData.ID, 1);
	...
	void GetClientState(){
		...
		} else if (PlayerManager.main.playerData.InventoryState.Level < a.minimumLevel) {
